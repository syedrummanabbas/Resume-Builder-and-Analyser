    ...
    if choice == 'Normal User':
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                resume_score = 0
                if ('Experience' or 'EXPERIENCE') in resume_text:
                    ...
                    st.markdown(
                        '''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add your Career Experience, it will give your career intension to the Recruiters.</h4>''',
                        unsafe_allow_html=True)
                ...
                if ('Skills'or 'SKILLS') in resume_text:
                    ...
                    st.markdown(
                        '''<h4 style='text-align: left; color: #fabc10;'>[-] According to our recommendation please add Skills✍.</h4>''',
                        unsafe_allow_html=True)
        ...
        if st.button('Login'):
            if ad_user == 'rumman' and ad_password == '123':
